"""Cross-domain investigation topics queue.

Tracks cross-domain topics to explore when reasoning across
expert knowledge bases. Topics surface during derive and
...
class Topic:
    ...
    title: str
    # Type of investigation: cross-domain, contradiction, derivation, or general
    kind: str
    # Target for the investigation (belief ID, agent pair, etc.)
    target: str
    # Why this was surfaced (which command generated it)
    source: str = ""
